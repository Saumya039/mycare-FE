...
function replaceInFile(filePath) {
  ...
  const replacements = [
    ...
    { regex: /(?<!dark:)bg-slate-900\/50/g, replacement: 'bg-white/60 dark:bg-slate-900/50' },
    { regex: /(?<!dark:)bg-slate-900/g, replacement: 'bg-white dark:bg-slate-900' },
    { regex: /(?<!dark:)bg-\[\#0b1437\]/g, replacement: 'bg-white dark:bg-[#0b1437]' },
    { regex: /(?<!dark:)bg-\[\#111c44\]/g, replacement: 'bg-slate-50 dark:bg-[#111c44]' },
    { regex: /(?<!dark:)bg-slate-800/g, replacement: 'bg-slate-100 dark:bg-slate-800' },
    { regex: /(?<!dark:)text-slate-100/g, replacement: 'text-slate-800 dark:text-slate-100' },
