...
export default function RadiologyPage() {
 ...
 <input type="text" placeholder="Search radiology scans..." className="w-full pl-10 pr-4 py-2 bg-white border border-slate-200 rounded-xl outline-none focus:border-indigo-500 transition-colors" />
 </div>
 </div>
 ...
 className="text-indigo-600 hover:text-indigo-700 font-medium text-sm flex items-center gap-1 justify-end w-full"
 >
 ...
 <select required value={orderForm.patientId} onChange={e => setOrderForm({...orderForm, patientId: e.target.value})} className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl outline-none focus:border-indigo-500 transition-colors">
 ...
 <div>
 <label className="block text-sm font-medium text-slate-600 mb-1">Scan Type (X-Ray, MRI, CT)</label>
 <input required value={orderForm.testName} onChange={e => setOrderForm({...orderForm, testName: e.target.value})} type="text" className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl outline-none focus:border-indigo-500 transition-colors" placeholder="e.g. Chest X-Ray (PA View)" />
 </div>
 ...
 <div>
 <label className="block text-sm font-medium text-slate-600 mb-1">Radiologist Findings</label>
 <textarea required value={resultText} onChange={e => setResultText(e.target.value)} rows={6} className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl outline-none focus:border-indigo-500 transition-colors" placeholder="Enter clinical findings, impressions, and radiologist notes..." />
 </div>
 <div className="pt-4 flex justify-end gap-3">
