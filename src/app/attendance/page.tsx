...
export default function AttendancePage() {
 ...
 className="lg:col-span-1 bg-white border border-slate-200 rounded-3xl p-8 shadow-sm flex flex-col items-center justify-center text-center"
 >
 <div className="w-24 h-24 rounded-full bg-cyan-50 flex items-center justify-center mb-6 shadow-inner">
 <Clock className="w-10 h-10 text-cyan-500" />
 </div>
 <h2 className="text-2xl font-bold text-slate-900 mb-2">Current Status</h2>
 
 <div className="mb-8">
 {loading ? (
 <p className="text-slate-500">Loading...</p>
 ) : !todayRecord ? (
 <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-100 text-slate-600 font-medium text-sm">
 Not Clocked In
 </span>
 ...
 className="lg:col-span-2 bg-white border border-slate-200 rounded-3xl shadow-sm overflow-hidden"
 >
