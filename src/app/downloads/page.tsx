...
export default function DownloadsPage() {
 ...
 key={doc.id} 
 className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm hover:shadow-xl transition-all group flex flex-col h-full"
 >
 ...
 target="_blank" 
 rel="noreferrer"
 className="w-full py-2.5 bg-slate-100 hover:bg-teal-500 hover:text-white text-slate-700 rounded-xl font-medium flex items-center justify-center gap-2 transition-colors"
 >
 ...
 <input required value={formData.title} onChange={e => setFormData({...formData, title: e.target.value})} type="text" className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl outline-none focus:border-teal-500 transition-colors" placeholder="e.g. Employee Handbook 2024" />
 </div>
 <div>
 <label className="block text-sm font-medium text-slate-600 mb-1">File Type</label>
 <select required value={formData.type} onChange={e => setFormData({...formData, type: e.target.value})} className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl outline-none focus:border-teal-500 transition-colors">
 ...
 <div>
 <label className="block text-sm font-medium text-slate-600 mb-1 flex items-center gap-1"><LinkIcon className="w-4 h-4"/> Document URL</label>
 <input required value={formData.url} onChange={e => setFormData({...formData, url: e.target.value})} type="url" className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl outline-none focus:border-teal-500 transition-colors" placeholder="https://..." />
 <p className="text-xs text-slate-500 mt-1">Provide a direct link to the hosted file.</p>
 </div>
 <div>
 <label className="block text-sm font-medium text-slate-600 mb-1">Uploaded By</label>
 <input value={formData.uploadedBy} onChange={e => setFormData({...formData, uploadedBy: e.target.value})} type="text" className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl outline-none focus:border-teal-500 transition-colors" placeholder="e.g. HR Dept" />
 </div>
