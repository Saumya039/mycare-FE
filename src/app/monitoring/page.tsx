    ...
    <div className="p-8 h-full bg-slate-950 text-slate-100">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-slate-400">Real-time vital sign monitoring across all departments</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {vitals.length === 0 && connectionStatus === "live" && (
          <div className="col-span-full p-8 text-center text-slate-500 bg-slate-900/50 rounded-2xl border border-slate-800">
        ...
        {vitals.map(v => {
          ...
          return (
            <div 
              key={v.patientId} 
              className={`bg-slate-900/80 backdrop-blur-xl border rounded-2xl p-5 shadow-xl transition-all ${
            ...
            >
              <div className="flex justify-between items-start mb-4 border-b border-slate-800 pb-3">
                <div>
                  <h3 className="font-semibold text-slate-200 truncate pr-2" title={v.name}>{v.name}</h3>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <div className={`text-3xl font-bold font-mono tracking-tighter ${isHrCritical ? 'text-red-400' : 'text-slate-100'}`}>
                    {v.heartRate}
                  </div>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className={`text-3xl font-bold font-mono tracking-tighter ${isO2Critical ? 'text-red-400' : 'text-slate-100'}`}>
                    {v.oxygenLevel}
                  </div>
                </div>

                {/* Blood Pressure */}
                <div className="col-span-2 mt-2 pt-3 border-t border-slate-800/50 flex justify-between items-end">
