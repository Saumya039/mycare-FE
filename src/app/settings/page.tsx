    ...
    <div className="p-8 h-full bg-slate-950 text-slate-100 overflow-y-auto">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold flex items-center gap-3">
            <Settings className="w-6 h-6 text-slate-400" /> System Configuration
          </h1>
          <p className="text-slate-400">Manage hospital-wide settings and integrations</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-6">
          <h2 className="text-lg font-semibold flex items-center gap-2 mb-6 border-b border-slate-800 pb-3">
        ...
        <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input type="password" value="************************" readOnly className="w-full bg-slate-950/50 border border-slate-800 rounded-lg px-4 py-2 text-slate-500 cursor-not-allowed" />
            ...
            <div className="flex items-center justify-between pt-4 mt-4 border-t border-slate-800">
              <span className="text-sm text-slate-300">Serva AI Auto-Summarization</span>
              <label className="relative inline-flex items-center cursor-pointer">
                <input type="checkbox" defaultChecked className="sr-only peer" />
