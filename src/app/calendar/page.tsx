...
export default function CalendarPage() {
 ...
 <h2 className="text-lg font-bold text-slate-900">{new Date(dateStr).toLocaleDateString(undefined, { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}</h2>
 </div>
 ...
 )) : <p className="text-sm text-slate-500 italic">No appointments</p>}
 </div>
 </div>
 ...
 <div>
 <p className="font-bold text-slate-900">{rst.user?.name}</p>
 ...
 )) : <p className="text-sm text-slate-500 italic">No duty rosters scheduled</p>}
 </div>
 </div>
