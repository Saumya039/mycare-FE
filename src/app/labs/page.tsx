              ...
              {loading ? (
                ...
                labs.map(lab => (
                  <tr key={lab.id} className="hover:bg-slate-800/20 transition-colors">
                    <td className="p-4 font-medium text-slate-200">{lab.testName}</td>
                    <td className="p-4">
                      <p className="font-medium text-slate-200">{lab.patient?.name}</p>
                      <p className="text-xs text-slate-500">{lab.patient?.patientId}</p>
                    </td>
                    <td className="p-4 text-sm text-slate-300">{new Date(lab.createdAt).toLocaleDateString()}</td>
                    <td className="p-4">
                        ...
                        activeResultId === lab.id ? (
                          <div className="flex items-center gap-2 justify-end">
                            <input 
                              ...
                              className="bg-slate-950 border border-slate-700 rounded px-2 py-1 text-xs outline-none focus:border-cyan-500"
