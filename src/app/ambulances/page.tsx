...
export default function AmbulancesPage() {
 ...
 <p className="text-slate-500">Manage emergency vehicle fleet and dispatch operations</p>
 </div>
 ...
 <div className="bg-white border border-emerald-500/20 rounded-2xl p-6 flex flex-col justify-center">
 <h3 className="text-emerald-400 font-semibold mb-2 flex items-center gap-2">
 <CheckCircle2 className="w-5 h-5" /> Available Fleet
 </h3>
 <p className="text-4xl font-bold text-slate-900">{availableCount}</p>
 </div>
 <div className="bg-white border border-amber-500/20 rounded-2xl p-6 flex flex-col justify-center">
 <h3 className="text-amber-400 font-semibold mb-2 flex items-center gap-2">
 <Navigation className="w-5 h-5" /> En Route
 </h3>
 <p className="text-4xl font-bold text-slate-900">{dispatchedCount}</p>
 </div>
 <div className="bg-white border border-slate-300 rounded-2xl p-6 flex flex-col justify-center">
 <h3 className="text-slate-500 font-semibold mb-2 flex items-center gap-2">
 <Truck className="w-5 h-5" /> In Maintenance
 </h3>
 <p className="text-4xl font-bold text-slate-900">{maintenanceCount}</p>
 </div>
 </div>
 ...
 <div className="col-span-full p-8 text-center text-slate-500 bg-white border border-slate-200 rounded-2xl">No ambulances registered.</div>
 ) : (
 ambulances.map(amb => (
 <div key={amb.id} className="bg-white border border-slate-200 rounded-2xl overflow-hidden flex flex-col group hover:border-slate-300 transition-colors">
 ...
 className="flex-1 bg-slate-100 hover:bg-slate-700 text-slate-700 px-3 py-2 rounded-lg text-xs font-medium transition-colors"
 >
 Send to Maintenance
 </button>
 </>
 ...
 <div>
 <label className="block text-sm font-medium text-slate-500 mb-1">Vehicle Number</label>
 <input 
 ...
 className="w-full bg-slate-50 border border-slate-200 rounded-lg px-4 py-2 text-slate-800 focus:outline-none focus:border-amber-500"
 />
 </div>

 <div>
 <label className="block text-sm font-medium text-slate-500 mb-1">Ambulance Type</label>
 <select 
 required 
 value={form.type} 
 ...
 <div>
 <label className="block text-sm font-medium text-slate-500 mb-1">Base Location</label>
 <input 
